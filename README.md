...
- **Visualization of Segmentation Outputs**: The segmentation outputs generated by both the **Basic CNN** and **Enhanced U-Net** models were visualized to qualitatively evaluate their performance on flood image semantic segmentation. The visualization helps compare the predicted segmentation masks with the corresponding ground truth masks and provides a better understanding of the models' segmentation quality.
